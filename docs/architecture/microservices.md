# Microservices Architecture (draft)

This file contains a Mermaid diagram of a suggested microservices architecture. You can preview this file in VS Code's Markdown preview or at https://mermaid.live/
